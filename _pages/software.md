...
3D Lipid Projection
------
A research visualization tool for high-dimensional lipidomics data.
Projects lipids and subjects using Isomap and UMAP to reveal global and local manifold structure, supporting feature selection for downstream ML and topological analysis.
Developed for tumor research at the University of Manitoba.
(Webpage in preparation)

3D Stack Image Annotator
------
A 3D-aware annotation tool for organoid imaging.
Enables efficient labeling across image stacks while preserving spatial consistency within complex 3D structures.
Designed to support deep learning pipelines for cancer organoid analysis at the University of Iowa. 
(Webpage in preparation)
